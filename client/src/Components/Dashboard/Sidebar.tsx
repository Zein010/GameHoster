...
export default function Sidebar() {
    ...
    return (
        ...
        >
            ...
            >
                <Link href={`/Dashboard/Servers`} underline="none" sx={{ gap: 1, backgroundColor: isActive(`/Dashboard/Servers`) ? "background.level2" : "", py: 0.5, px: 1, borderRadius: 10 }}>
                    <TerminalIcon />
                    <Typography level="title-sm">Serves</Typography>
                </Link>

                <Link href={`/Dashboard/Profile`} underline="none" sx={{ gap: 1, backgroundColor: isActive(`/Dashboard/Profile`) ? "background.level2" : "", py: 0.5, px: 1, borderRadius: 10 }}>
                    <PersonIcon />
                    <Typography level="title-sm">Profile</Typography>
                </Link>

                <Link href={`/Dashboard/Friends`} underline="none" sx={{ gap: 1, backgroundColor: isActive(`/Dashboard/Friends`) ? "background.level2" : "", py: 0.5, px: 1, borderRadius: 10 }}>
                    <ArchiveIcon />
