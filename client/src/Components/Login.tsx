...
export default function Login() {
    const [loginState, setLoginState] = useState<"signUp" | "loggedOut" | "2faRequired" | "2FAApp" | "2FAEmail">("loggedOut");
    const loginStateComponentMapper = {
        loggedOut: <SignIn setLoginState={setLoginState} />,
        signUp: <SignUp setLoginState={setLoginState} />,
        ...
        <CssVarsProvider disableTransitionOnChange>
            ...
            >
                ...
                >
                    ...
                    >
                        <Stack sx={{ gap: 4, mt: 2 }}>{loginStateComponentMapper[loginState]}</Stack>
                    </Box>
