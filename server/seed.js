...
const seed = async () => {
  try {
    ...
    console.log("Created Astrioneer Version")
    await prisma.gameVersion.upsert({
      where: { id: 5 },
      create: { id: 5, searchShScript: "rust", version: "Rust", searchScript: "rust", gameId: 2, downloadLink: null },
      update: { searchShScript: "rust", version: "Rust", searchScript: "rust", gameId: 2, downloadLink: null },
    });
    console.log("Created Rust Version")
